...
@section('content')
<h1 class="t-text-3xl lg:t-text-5xl font-bold t-mb-4">Logo Media</h1>
<hr />
...
<table class="t-table-auto t-bg-white t-m-4 t-w-full t-border-gray-500">
    ...
    <tbody>
        @if($logo->media->count())
            @foreach($logo->getMedia('logo') as $media)
            <tr>
...
<br />
{!! Form::model($logo, ['method' => 'GET', 'action' => 'LogoController@addMedia']) !!}
