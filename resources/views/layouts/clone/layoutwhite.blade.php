...
<head>
    ...
    <!--[if (gt IE 9)|!(IE)]><!-->
    @if($local)
    <script src="/local/js/theme.js" defer="defer"></script>
    @else
    ...
    <!--[if (gt IE 9)|!(IE)]><!-->
    @if($local)
    <script src="/local/js/head.js" defer="defer"></script>
    @else
...
<body id="with-love-darling" class="template-index" data-promo="true" data-animations="true" data-endless-scroll="true">
        ...
        <div id="shopify-section-header" class="shopify-section">
            ...
            <header class="site-header header--normal header__wrapper" id="header" data-section-id="header" data-section-type="header" data-overlay="false">
                ...
                <div class="header__content">
                    ...
                    @include('layouts.clone.navwhite')
    ...
    @if($local)
    <script src="/local/js/api.jquery-e94e010e92e659b566dbc436fdfe5242764380e00398907a14955ba301a4749f.js" type="text/javascript"></script>
    <script>
        Shopify.money_format = '$1.00';
    </script>
    <script src="/local/js/currencies.js" type="text/javascript"></script>
    <script src="/local/js/jquery.currencies.min.js" type="text/javascript"></script>
    @else
