        ...
        <div class="product__wrapper">
            <nav class="breadcrumbs">
                <small>
                    ...
                    <a href="/" title="">KONKURRENCER</a>
                    <span class="breadcrumbs__arrow">
                        <svg aria-hidden="true" focusable="false" role="presentation" class="icon icon-arrow-right" viewBox="0 0 20 38">
                            <path d="M15.932 18.649L.466 2.543A1.35 1.35 0 0 1 0 1.505c0-.41.155-.77.466-1.081A1.412 1.412 0 0 1 1.504 0c.41 0 .756.141 1.038.424l16.992 17.165c.31.283.466.636.466 1.06 0 .423-.155.777-.466 1.06L2.542 36.872a1.412 1.412 0 0 1-1.038.424c-.41 0-.755-.141-1.038-.424A1.373 1.373 0 0 1 0 35.813c0-.423.155-.776.466-1.059L15.932 18.65z" fill="#726D75" fill-rule="evenodd"/>
                        </svg>
                    </span>
                    <a href="//contests.withlovedarling.dk/entry/{{ $entry->id }}">{{ $entry->name }}  </a>
                </small>
            </nav>
                                ...
                                <div class="product__form">
                                    <div class="product__sharing">
                                        ...
                                        <div class="sharing" style="margin:0;padding:0;">
                                            ...
                                            <a class="share share--twitter" target="_blank" href="//twitter.com/share?text={{ urlencode($entry->name.$entry->hashtag) }}&amp;url=https://contests.withlovedarling.com/product/{{ $entry->id }}">
                                            ...
                                            <a class="share share--pinterest" target="_blank" href="//pinterest.com/pin/create/button/?url=https://contests.withlovedarling.com/product/{{ $entry->id }}&amp;media=https://contests.withlovedarling.com/{{ $entry->getMedia('entries')[0]->getUrl('responsive') }}&amp;description={{ urlencode($entry->name) }}">
                                    ...
                                    <div id="votes" class="product__submit product__submit--spb" data-product-id="3928106565731">
                                        <div class="product__submit__buttons">
                                            <button id="bvote" type="button"  class="btn vote-button product__submit__add" onclick="location.href = '/vote/{{$entry->id}}';"><a href="/vote/{{$entry->id}}">Vote ({{ count($votes)}})</a></button>
                                        </div>
                                        <script>
                                            function myFunction() {
                                              document.getElementById("bvote").value = document.getElementById("field1").value;
                                            }
                                        </script>
                                    </div>
                                </div>
