            ...
            <div class="grid">
                <div id="howtoenter" class="grid__item medium-up--push-one-twelfth medium-up--four-fifths">
                    ...
                    <div class="row">
                        <div  class="col">
                            <ul>
                                <li>Remember: We're looking for a design of a piece of jewellery that you feel represents and symbolizes the values of <b>Global Goal #1</b> and <b>Red Nose Day</b>. You can learn more about the Global Goals <a href="https://www.globalgoals.org" target="_blank">here</a></li>
                                <li>This piece should be a pendant or charm that can be attached to a necklace or bracelet. We reserve the right to change the size.</li>
                            </ul>
                            <h4>STEP 1: CREATE</h4>
                            <ul>
                                ...
                                <li>Draw your design, whether it be simply on paper, or on a tablet. All that matters is that the design is clear, concise, and able to be sent to us in an Image format.</li>
                            </ul>
                        </div>
                        <div class="col">
                            ...
                            <ul>
                                ...
                                <li>Upload your design and writing onto the With Love Dariling website in the contest section. Be sure to include all information about yourself, where we can contact you, and about your gorgeous design. Remember, the deadline to submit your design is <b>{{ $contest->getSubmitDateText() }}</b>.</li>
                                <li>Feel free to promote your work on all social media platforms to get other to vote!</li>
                                <li>Announcement of the finalists will be on <b>{{ $contest->getVoteDateText() }}</b>. The With Love Darling team and voters will carefully choose which pieces make it to the next round. Voting closes on <b>{{ $contest->getEndDateText() }}</b>.</li>
                            </ul>
                        </div>
                    </div>                    
                </div>
