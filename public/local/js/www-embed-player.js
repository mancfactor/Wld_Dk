...
;var Te=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};w("yt.msgs_",Te,void 0);function Ue(a){Yd(Te,arguments)}
...
;var Ze=y("ytPubsubPubsubInstance")||new M;M.prototype.subscribe=M.prototype.subscribe;M.prototype.unsubscribeByKey=M.prototype.N;M.prototype.publish=M.prototype.M;M.prototype.clear=M.prototype.clear;w("ytPubsubPubsubInstance",Ze,void 0);var $e=y("ytPubsubPubsubSubscribedKeys")||{};w("ytPubsubPubsubSubscribedKeys",$e,void 0);var af=y("ytPubsubPubsubTopicToKeys")||{};w("ytPubsubPubsubTopicToKeys",af,void 0);var bf=y("ytPubsubPubsubIsSynchronous")||{};w("ytPubsubPubsubIsSynchronous",bf,void 0);
...
;var Lf=0;w("ytDomDomGetNextId",y("ytDomDomGetNextId")||function(){return++Lf},void 0);var Mf={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,screenX:1,screenY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};
...
Nf.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var Va=y("ytEventsEventsListeners")||{};w("ytEventsEventsListeners",Va,void 0);var Pf=y("ytEventsEventsCounter")||{count:0};w("ytEventsEventsCounter",Pf,void 0);
...
function Wf(a){var b=void 0===a?{}:a;a=void 0===b.Aa?!0:b.Aa;b=void 0===b.Ma?!1:b.Ma;if(null==y("_lact",window)){var c=parseInt(O("LACT"),10);c=isFinite(c)?B()-Math.max(c,0):-1;w("_lact",c,window);w("_fact",c,window);-1==c&&Xf();V(document,"keydown",Xf);V(document,"keyup",Xf);V(document,"mousedown",Xf);V(document,"mouseup",Xf);a&&(b?V(window,"touchmove",function(){Yf("touchmove",200)},{passive:!0}):(V(window,"resize",function(){Yf("resize",200)}),V(window,"scroll",function(){Yf("scroll",200)})));
...
function Xf(){null==y("_lact",window)&&Wf();var a=B();w("_lact",a,window);-1==y("_fact",window)&&w("_fact",a,window);(a=y("ytglobal.ytUtilActivityCallback_"))&&a()}
function Zf(){var a=y("_lact",window);return null==a?-1:Math.max(B()-a,0)}
;var $f=Math.pow(2,16)-1,ag=null,bg=0,cg={log_event:"events",log_interaction:"interactions"},dg=Object.create(null);dg.log_event="GENERIC_EVENT_LOGGING";dg.log_interaction="INTERACTION_LOGGING";var eg=new Set(["log_event"]),fg={},gg=0,hg=0,ig=0,W=y("ytLoggingTransportLogPayloadsQueue_")||{};w("ytLoggingTransportLogPayloadsQueue_",W,void 0);var jg=y("ytLoggingTransportTokensToCttTargetIds_")||{};w("ytLoggingTransportTokensToCttTargetIds_",jg,void 0);var kg=y("ytLoggingTransportDispatchedStats_")||{};
w("ytLoggingTransportDispatchedStats_",kg,void 0);w("ytytLoggingTransportCapturedTime_",y("ytLoggingTransportCapturedTime_")||{},void 0);function lg(){S(gg);S(hg);hg=0;if(!Wa(W)){for(var a in W){var b=fg[a];b&&(mg(a,b),delete W[a])}Wa(W)||ng()}}
...
;var rg=y("ytLoggingGelSequenceIdObj_")||{};w("ytLoggingGelSequenceIdObj_",rg,void 0);
...
xg.prototype.toString=function(){return this.topic};var yg=y("ytPubsub2Pubsub2Instance")||new M;M.prototype.subscribe=M.prototype.subscribe;M.prototype.unsubscribeByKey=M.prototype.N;M.prototype.publish=M.prototype.M;M.prototype.clear=M.prototype.clear;w("ytPubsub2Pubsub2Instance",yg,void 0);var zg=y("ytPubsub2Pubsub2SubscribedKeys")||{};w("ytPubsub2Pubsub2SubscribedKeys",zg,void 0);var Ag=y("ytPubsub2Pubsub2TopicToKeys")||{};w("ytPubsub2Pubsub2TopicToKeys",Ag,void 0);var Bg=y("ytPubsub2Pubsub2IsAsync")||{};w("ytPubsub2Pubsub2IsAsync",Bg,void 0);
w("ytPubsub2Pubsub2SkipSubKey",null,void 0);function Cg(a,b){var c=Dg();c&&c.publish.call(c,a.toString(),a,b)}
...
return a.join("")}
;var Zg=y("ytLoggingTimeDocumentNonce_")||Yg();w("ytLoggingTimeDocumentNonce_",Zg,void 0);function $g(a){a=void 0===a?0:a;return 0==a?"client-screen-nonce":"client-screen-nonce."+a}
function ah(a){a=void 0===a?0:a;return 0==a?"ROOT_VE_TYPE":"ROOT_VE_TYPE."+a}
function bh(a){return O(ah(void 0===a?0:a),void 0)}
w("yt_logging_screen.getRootVeType",bh,void 0);function ch(){var a=bh(0),b;a?b=new tg({veType:a,youtubeData:void 0}):b=null;return b}
...
w("yt_logging_screen.getCurrentCsn",dh,void 0);function eh(a,b,c){c=void 0===c?0:c;if(a!==O($g(c))||b!==O(ah(c)))N($g(c),a),N(ah(c),b),0==c&&(b=function(){setTimeout(function(){a&&sg("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:Zg,clientScreenNonce:a},Ng)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b())}
w("yt_logging_screen.setCurrentScreen",eh,void 0);function fh(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=O("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=O("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=I(J(3,window.location.href));g&&f.push(g);g=I(J(3,d));if(0<=Ja(f,g)||!g&&0==d.lastIndexOf("/",0))if(Q("autoescape_tempdata_url")&&(f=document.createElement("a"),Ib(f,d),d=f.href),d){g=d.match(ic);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&!b.csn&&(b.itct||
b.ved)&&(b=Object.assign({csn:dh()},b)),k){var k=parseInt(k,10);isFinite(k)&&0<k&&(e=b,b="ST-"+Lb(d).toString(36),e=e?kc(e):"",Rg(b,e,k||5))}else k=b,e="ST-"+Lb(d).toString(36),k=k?kc(k):"",Rg(e,k,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var n=void 0===n?"":n;var p=void 0===p?window:p;c=p.location;a=lc(a,l)+n;a=a instanceof G?a:yb(a);c.href=wb(a)}return!0}
...
a.K=!0;b?a.B():(lf(vh(a),a.B),jh(a.o?a.o.cssUrl:a.f.assets.css),yh(a)&&!c&&w("yt.player.Application.create",null,void 0))}}}
...
;function Yh(){var a=y("ytcsi.debug");a||(a=[],w("ytcsi.debug",a,void 0),w("ytcsi.reference",{},void 0));return a}
...
function ki(){return!!O("FORCE_CSI_ON_GEL",!1)||Q("csi_on_gel")||!!Qh(void 0).useGel}
...
;w("yt.setConfig",N,void 0);w("yt.config.set",N,void 0);w("yt.setMsg",Ue,void 0);w("yt.msgs.set",Ue,void 0);w("yt.logging.errors.log",Se,void 0);
